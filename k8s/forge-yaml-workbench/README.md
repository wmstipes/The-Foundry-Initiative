...
The tracked Deployment now stages immutable `0.6.0` for dry-run and diff review. The live cluster remains on accepted immutable `0.5.1` until separate deployment approval.
