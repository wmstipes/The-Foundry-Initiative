...
Review and explicitly approve immutable multi-architecture publication of the accepted `0.7.0` candidate. Deployment, live acceptance, and merge remain later approval gates.
